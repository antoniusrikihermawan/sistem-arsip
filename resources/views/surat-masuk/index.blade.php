    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center mb-2">
                <h3 class="card-title fw-bold">Daftar Surat Masuk</h3>
            ...
            <form action="{{ route('surat-masuk.index') }}" method="GET" class="mt-3">
                    ...
                    <div class="col-md-2">
                        <div class="d-flex w-100">
                            ...
                            @if(request()->hasAny(['search', 'start_date', 'end_date']))
                                <a href="{{ route('surat-masuk.index') }}" class="btn btn-secondary btn-sm w-100">
                ...
                <tbody>
                    @forelse ($suratMasuk as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('surat-masuk.show', $item->id_surat) }}" class="btn btn-info btn-sm">Detail</a>
                                <a href="{{ route('surat-masuk.edit', $item->id_surat) }}" class="btn btn-warning btn-sm">Edit</a>
                                <form action="{{ route('surat-masuk.destroy', $item->id_surat) }}" method="POST" class="d-inline" onsubmit="confirmDelete(event, 'Yakin ingin menghapus data surat masuk ini?')">
                                    @csrf
                                    @method('DELETE')
